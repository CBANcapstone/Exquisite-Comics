...
export default class extends Component {
    ...
    render() {
        ...
        return (
            ...
            <button onClick={this.handleExportClick}>{typeof this.state.pic}</button>
